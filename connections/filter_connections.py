...
at_least_as_follower = lambda n = 0: [t for t in connection_as_follower if t[1] >= n]
at_least_as_following = lambda n = 0: [t for t in connection_as_following if t[1] >= n]
